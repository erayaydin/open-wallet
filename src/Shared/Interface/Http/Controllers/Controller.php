...
use OpenWallet\Shared\Infrastructure\Laravel\Traits\AsksQuery;
...
{
    use AsksQuery, AuthorizesRequests, DispatchesCommand, DispatchesJobs, GeneratesUuid, ValidatesRequests;
}
